  ...
  return (
    <>
      ...
      <section className="relative py-20 bg-black overflow-hidden">
        {/* Background with subtle blue glow - always visible */}
        ...
        <div className="container mx-auto px-4 relative z-20">
          ...
          {/* Collapsible Content - TODO EL CONTENIDO PESADO AQUÍ */}
          {isExpanded && (
            <div className="relative">
              {/* 3D Tubes Cursor Canvas - Solo cuando expandido */}
              <canvas
                ref={canvasRef}
                id="tubes-canvas"
              ...
              {/* Spotify Player */}
              {showSpotify && (
                <div className="mb-16 max-w-4xl mx-auto animate-fadeIn relative z-20">
              ...
              <div className="mb-16 max-w-5xl mx-auto relative z-20">
                      ...
                      <div className="relative group">
                        ...
                        <div className="relative w-32 h-32 md:w-40 md:h-40">
                          <Image
                            ...
                            alt="Nervous Records"
                            fill
                            className="object-contain filter drop-shadow-[0_0_20px_rgba(255,227,13,0.3)]"
                          />
                        </div>
                      </div>
                    </div>
              ...
              {/* Video Grid */}
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 relative z-20">
      ...
      <style jsx>{`
        ...
        @keyframes nervous-glow {
          0%, 100% {
            box-shadow: 0 0 40px rgba(255, 227, 13, 0.1);
          }
          50% {
            box-shadow: 0 0 60px rgba(255, 227, 13, 0.2);
          }
        }
        ...
        .animate-glitch-border {
          animation: glitch-border 0.3s linear infinite;
        }
        ...
        .animate-beat-pulse {
          animation: beat-pulse 0.96s ease-in-out infinite;
        }
        ...
        .animate-beat-scale {
          animation: beat-scale 0.96s ease-in-out infinite;
        }
        ...
        .animate-nervous-glow {
          animation: nervous-glow 2s ease-in-out infinite;
        }

        .animate-nervous-pulse {
          animation: nervous-pulse 2s ease-in-out infinite;
        }
      `}</style>
    </>
  );
